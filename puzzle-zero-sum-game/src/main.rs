...
use crate::{data_structures::Statement, prover::{prove, malicious_prover}, verifier::verify};
...
fn main() {
    ...
    let proof = malicious_prover::<F, PC, FS, StdRng>(&ck, &statement, &f, &f_rand[0], &mut rng).unwrap();
