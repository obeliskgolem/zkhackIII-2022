...
use crate::utils::pow_sp;
use num_traits::One;
use crate::{attack::*, verify::verify};
...
fn main() {
    ...
    // let k0 = 1089539821761426u128;
    let k0 = calc_k0(P, tau_P, tau_d1_P, Q, tau_d2_Q, d);


    // let k1 = 690599720u128;
    let k1 = calc_k1(P, tau_P, tau_d1_P, Q, tau_d2_Q, d, k0);

    println!("k0 = {k0}");
    println!("k1 = {k1}");
    verify_k0(P, tau_P, tau_d1_P, Q, tau_d2_Q, d, k0);

    // let tau = 284865198031253921498207i128
    let tau = attack(P, tau_P, tau_d1_P, Q, tau_d2_Q, d, k0, k1);

    println!("tau = {}", tau);

    // assert_eq!(true, verify(P, tau_P, tau));
    assert_eq!(true, verify(P, tau_P, 284865198031253921498207i128));
}
